...
public class Mpass1 {
	...
	public static void main(String[] args)throws IOException {
		BufferedReader br1 = new BufferedReader(new FileReader("C:\\Users\\sahad\\OneDrive\\Desktop\\sahadevkadamTCOB22\\MacroAssembler\\src\\input3.txt"));
        String line;
		mdt[] MDT = new mdt[20];
		mnt[] MNT = new mnt[4];
		...
		BufferedWriter bw1=new BufferedWriter(new FileWriter("C:\\Users\\sahad\\OneDrive\\Desktop\\sahadevkadamTCOB22\\MacroAssembler\\src\\MNT.txt"));
		System.out.println("\n\t*MACRO NAME TABLE*");
		System.out.print("\n\tINDEX\tNAME\tADDRESS \n");
		...
		bw1=new BufferedWriter(new FileWriter("C:\\Users\\sahad\\OneDrive\\Desktop\\sahadevkadamTCOB22\\MacroAssembler\\src\\MDT.txt"));
		System.out.println("\n\t*ARGUMENT LIST*");
		System.out.print("\n\tINDEX\tNAME\tADDRESS \n");
