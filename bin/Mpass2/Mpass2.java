...
public class Mpass2{
	public static void main(String[] args) throws IOException{
		...
		BufferedReader br1=new BufferedReader(new FileReader("C:\\Users\\sahad\\OneDrive\\Desktop\\sahadevkadamTCOB22\\Mpass2\\src\\MNT.txt"));
		String line;
		...
		br1=new BufferedReader(new FileReader("C:\\Users\\sahad\\OneDrive\\Desktop\\sahadevkadamTCOB22\\Mpass2\\src\\argmnt.txt"));
		while((line=br1.readLine())!=null)
		{
		...
		br1=new BufferedReader(new FileReader("C:\\Users\\sahad\\OneDrive\\Desktop\\sahadevkadamTCOB22\\Mpass2\\src\\MDT.txt"));
		while((line=br1.readLine())!=null)
		{
			MDT[mdt_cnt]=new mdt();
		...
		br1=new BufferedReader(new FileReader("C:\\Users\\sahad\\OneDrive\\Desktop\\sahadevkadamTCOB22\\Mpass2\\src\\input.txt"));
		
		BufferedWriter bw1=new BufferedWriter(new FileWriter("C:\\Users\\sahad\\OneDrive\\Desktop\\sahadevkadamTCOB22\\Mpass2\\src\\output.txt"));
		while((line=br1.readLine())!=null)
		{
